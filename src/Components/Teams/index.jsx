import Pic from "../../Assets/9.webp";
import Pic2 from "../../Assets/10.webp";
import Pic3 from "../../Assets/11.webp";
import Pic4 from "../../Assets/12.webp";
        ...
        <section className="md:w-56 lg:w-60 xl:w-64 2xl:w-72 rounded-md shadow-md bg-secondary">
            <div className="p-5">
                <div className="flex items-center justify-between py-1.5">
                    <div>
                        <h1 className="text-2xl text-white font-semibold">Teams</h1>
                    </div>
